...
#   {
#     name: "David Antunes",
#     phone_number: "(862) 231-6170",
#     email: "david@hairbydavid.com",
#     address: "111 Frank E Rodgers Blvd S, Harrison, NJ 07029",
#     years_experience: 25,
#     start_time: "11:30 AM",
#     end_time: "08:00 PM",
#     monday: false,
...
#     saturday: true,
#     sunday: false,
#     profile_picture: "https://i.imgur.com/A243dfN.jpg"
#   }
# )
#
# # David Antunes (id: 3) Services
# StylistService.create(stylist_id: 3, service_id: 1, duration_id: 2)
# StylistService.create(stylist_id: 3, service_id: 6, duration_id: 2)
# StylistService.create(stylist_id: 3, service_id: 10, duration_id: 1)
# StylistService.create(stylist_id: 3, service_id: 11, duration_id: 1)
# StylistService.create(stylist_id: 3, service_id: 12, duration_id: 2)
# StylistService.create(stylist_id: 3, service_id: 13, duration_id: 1)

# Picture.create(stylist_id: 3, url: "https://i.imgur.com/shMsaUx.jpg")
#
# Picture.create(stylist_id: 3, url: "https://i.imgur.com/1qRgw8t.jpg")
#
# Picture.create(stylist_id: 3, url: "https://i.imgur.com/5zItB0T.jpg")
#
# puts "Added Stylist 3's pictures"

# Stylist.create(
#   {
#     name: "Kilo Cutz",
#     phone_number: "(201) 948-5209",
#     email: "kilo@diamondcuts.com",
#     address: "239 Harrison Ave, Harrison, NJ 07029",
#     years_experience: 7,
#     start_time: "10:30 AM",
#     end_time: "07:30 PM",
#     monday: false,
...
#     saturday: true,
#     sunday: true,
#     profile_picture: "https://i.imgur.com/Fgmv0eI.jpg"
#   }
# )
#
# # Kilo Santana (id: 4) Services
# StylistService.create(stylist_id: 4, service_id: 1, duration_id: 2)
# StylistService.create(stylist_id: 4, service_id: 2, duration_id: 1)
# StylistService.create(stylist_id: 4, service_id: 3, duration_id: 1)
# StylistService.create(stylist_id: 4, service_id: 4, duration_id: 1)
# StylistService.create(stylist_id: 4, service_id: 5, duration_id: 3)
# StylistService.create(stylist_id: 4, service_id: 6, duration_id: 2)
# StylistService.create(stylist_id: 4, service_id: 7, duration_id: 1)
# StylistService.create(stylist_id: 4, service_id: 8, duration_id: 1)
# StylistService.create(stylist_id: 4, service_id: 9, duration_id: 1)
# StylistService.create(stylist_id: 4, service_id: 10, duration_id: 1)
# StylistService.create(stylist_id: 4, service_id: 11, duration_id: 1)
# StylistService.create(stylist_id: 4, service_id: 12, duration_id: 2)
# StylistService.create(stylist_id: 4, service_id: 13, duration_id: 1)

# Picture.create(stylist_id: 4, url: "https://i.imgur.com/EpMrlnd.jpg")
#
# Picture.create(stylist_id: 4, url: "https://i.imgur.com/yo9Yfxy.jpg")
#
# Picture.create(stylist_id: 4, url: "https://i.imgur.com/yAhhCgw.jpg")
#
#
# Picture.create(stylist_id: 4, url: "https://i.imgur.com/UCbhHqy.jpg")
#
# Picture.create(stylist_id: 4, url: "https://i.imgur.com/hikAq7D.jpg")
#
# Picture.create(stylist_id: 4, url: "https://i.imgur.com/JEDem2c.jpg")
#
#
# Picture.create(stylist_id: 4, url: "https://i.imgur.com/rx0zmHG.jpg")
#
# Picture.create(stylist_id: 4, url: "https://i.imgur.com/YNirxTR.jpg")
#
# Picture.create(stylist_id: 4, url: "https://i.imgur.com/22NTUwe.jpg")
#
# puts "Added Stylist 4's pictures"


# Stylist.create(
#   {
#     name: "Manuela Montoya",
#     phone_number: "(954) 708-0990",
#     email: "manuela@barber.com",
#     address: "12430 NE 6th Ave, Miami, FL 33161",
#     years_experience: 5,
#     start_time: "9:00 AM",
#     end_time: "03:00 PM",
#     monday: false,
...
#     saturday: true,
#     sunday: false,
#     profile_picture: "https://i.imgur.com/Bkvz5H4.jpg"
#   }
# )
#
...
# Service.create(title: "The Donald")         # id: 14
#
# # Manuela Montoya (id: 5) Services
# StylistService.create(stylist_id: 5, service_id: 1, duration_id: 2)
#
# StylistService.create(stylist_id: 5, service_id: 4, duration_id: 1)
# StylistService.create(stylist_id: 5, service_id: 5, duration_id: 3)
#
# StylistService.create(stylist_id: 5, service_id: 7, duration_id: 1)
# StylistService.create(stylist_id: 5, service_id: 8, duration_id: 1)
#
# StylistService.create(stylist_id: 5, service_id: 11, duration_id: 1)
# StylistService.create(stylist_id: 5, service_id: 12, duration_id: 2)
# StylistService.create(stylist_id: 5, service_id: 13, duration_id: 1)


# Picture.create(stylist_id: 5, url: "https://i.imgur.com/a8gpYvx.jpg")
#
# Picture.create(stylist_id: 5, url: "https://i.imgur.com/t6vilAO.jpg")
#
# Picture.create(stylist_id: 5, url: "https://i.imgur.com/wK3jtWG.jpg")

Picture.create(stylist_id: 5, url: "https://i.imgur.com/XnNxyan.jpg")

Picture.create(stylist_id: 5, url: "https://i.imgur.com/s0FWbVF.jpg")

Picture.create(stylist_id: 5, url: "https://i.imgur.com/fKA51Bi.jpg")

puts "Added Stylist 5's pictures"

#
# Stylist.create(
#   {
#     name: "Donald J. Trump",
#     phone_number: "(123) IAM-PREZ",
...
#     saturday: true,
#     sunday: false,
#     profile_picture: "https://i.imgur.com/pwrsBjR.jpg"
#   }
# )
#
# # Donald Trump (id: 6) Services
# StylistService.create(stylist_id: 6, service_id: 14, duration_id: 10)

# Picture.create(stylist_id: 6, url: "https://i.kym-cdn.com/photos/images/original/001/340/478/152.jpg")
#
# Picture.create(stylist_id: 6, url: "https://i.imgur.com/LoqlRfa.jpg")
#
# Picture.create(stylist_id: 6, url: "https://i.imgur.com/QE3lAYv.png")
#
# puts "Added Stylist 6's pictures"
#

# puts "Made second batch of barbers and their services"
# Stylist.create(
#   {
#     name: "Jaime Anglero",
...
#     saturday: false,
#     sunday: false,
#     profile_picture: "https://i.imgur.com/PMPdQTu.png"
#   }
# )
#
# Stylist.create(
...
#     saturday: true,
#     sunday: true,
#     profile_picture: "https://imgur.com/VEIbVeU.png"
#   }
# )
#
...
#
# puts "Added Stylist 1's pictures"
#
#
